    ...
    ModuleOS() {
        ...
        os.add_command(
            ...
            [](std::vector<GeneralTypeToken> args)->Variable {
                ...
                return (Variable)ret.substr(0,ret.size()-1); // removes a nasty '\n'
            }}
        ).add_command(
            {"sleep",
            {
            ...
            [](std::vector<GeneralTypeToken> args)->Variable {
                ...
                return (Variable)MEOWSCRIPT_OS_NAME;
            }}
        ).add_command(
            {"exit",
            {
            ...
            [](std::vector<GeneralTypeToken> args)->Variable {
                ...
                return (Variable)(MEOWSCRIPT_VERSION_STR);
            }}
        ).add_command(
            {"origin_file",
            {
            ...
            [](std::vector<GeneralTypeToken> args)->Variable {
                ...
                return (Variable)global::origin_file;
            }}
        ).add_command(
            {"main_file",
            {
            ...
            [](std::vector<GeneralTypeToken> args)->Variable {
                ...
                return (Variable)global::include_path.top().string();
            }}
        ).add_command(
            {"clear",
            {
            ...
            [](std::vector<GeneralTypeToken> args)->Variable {
                ...
                return (Variable)std::to_string(time(NULL));
            }}
        ).add_command(
            {"time",
            {
